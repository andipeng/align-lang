...
ilga_phi_hat = {
    'peach': ["orange", "red", "yellow", "dark orange", "dark pink", "dark purple", "dark red", "dark yellow"],
    'tomato': ["orange", "purple", "red", "dark orange", "dark pink", "dark purple", "dark red", "dark yellow"],
    'pepper': ["orange", "pink", "purple", "red", "yellow", "dark orange", "dark pink", "dark red", "dark yellow"],
    'apple': ["orange", "pink", "purple", "red", "yellow", "dark orange", "dark pink","dark red", "dark yellow"],
}
...
gt_phi_hat = {
    ...
    'apple': ["orange", "pink", "purple", "red", "yellow", "dark orange", "dark pink", "dark purple", "dark red", "dark yellow"],
}
